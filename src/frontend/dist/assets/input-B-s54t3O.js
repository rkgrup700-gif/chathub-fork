...
import { g as Subscribable, p as pendingThenable, h as resolveEnabled, s as shallowEqualObjects, i as resolveStaleTime, n as noop, k as environmentManager, l as isValidTimeout, t as timeUntilStale, m as timeoutManager, o as focusManager, q as fetchState, v as replaceData, w as notifyManager, x as hashKey, y as getDefaultState, r as reactExports, z as shouldThrowError, e as useQueryClient, A as useRouterState, j as jsxRuntimeExports, R as React, B as shimExports, c as cn, C as clsx, D as useInternetIdentity, L as Link } from "./index-CW3Vuo4s.js";
...
function useAuth() {
  ...
  return {
    ...
    login,
    logout: clear,
    principalId: identity == null ? void 0 : identity.getPrincipal().toText()
  };
}
...
function AuthenticatedLayout({ children }) {
  ...
  const initials = (profile == null ? void 0 : profile.displayName) ? profile.displayName.split(" ").map((n) => n[0]).join("").toUpperCase().slice(0, 2) : "ME";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-background overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "aside",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/chat", className: "mb-4 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-9 rounded-xl bg-primary flex items-center justify-center shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            MessageCircle,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "nav",
            {
              ...
              "data-ocid": "main.nav",
              children: NAV_ITEMS.map(({ to, icon: Icon2, label, badge }) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Link,
                  {
                    ...
                    children: [
                      ...
                      badge ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1.5 right-1.5 size-4 bg-primary text-primary-foreground text-[9px] font-bold rounded-full flex items-center justify-center", children: badge }) : null,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2 px-2 mt-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "size-9 ring-2 ring-primary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary/20 text-primary text-xs font-bold", children: initials }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(PresenceDot, {})
            ] })
          ] })
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: mobileOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "size-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "size-4" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 min-w-0 flex flex-col overflow-hidden", children })
  ] });
}
function PublicLayout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-card border-b border-border px-6 py-4 flex items-center justify-between shadow-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded-lg bg-primary flex items-center justify-center shadow-message", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              MessageCircle,
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border py-5 px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
      "© ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: `https://caffeine.ai?utm_source=caffeine-footer&utm_medium=referral&utm_content=${encodeURIComponent(
            typeof window !== "undefined" ? window.location.hostname : "chathub.com"
          )}`,
          target: "_blank",
